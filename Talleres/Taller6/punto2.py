...
def main():
    ...
    cliente1 = Cliente("Julieth Gaitan", 1, "123", "Calle 1", "Julieth@mail.com", "Tarjeta")
    repartidor1 = Repartidor("Luis", 2, "456", "Calle 2", "Luis@mail.com", "Moto")
    repartidorCliente1 = RepartidorCliente("Julian", 3, "789", "Calle 3", "JRS@mail.com", "Efectivo", "Moto")
    ...
    with open("personas.txt", "a", encoding="utf8") as file:
        for persona in listaPersonas:
